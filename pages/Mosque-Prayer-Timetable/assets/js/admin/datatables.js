 ...
 *   https://datatables.net/download/#dt/dt-1.12.1/fh-3.2.4/sc-2.0.7/sp-2.0.2
 *
 * Included libraries:
 *   DataTables 1.12.1, FixedHeader 3.2.4, Scroller 2.0.7, SearchPanes 2.0.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.12.1/fh-3.2.4/sc-2.0.7/sp-2.0.2",
